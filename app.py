...
# --- Sidebar Menu ---
menu_options = ["🏠 Home", "🥗 Nutrition Analysis", "🤖 Nutrition Chatbot"]
...
if menu == "🏠 Home":
    st.title("🥗 Nutrition Analysis & Chatbot App")

    st.markdown("""
    Welcome to the **Nutrition Analysis and Chatbot App**! This tool helps you:

    - 🔍 Analyze the nutritional content of your meals
    - 📈 Visualize and compare your intake with recommended daily values
    - 🧠 Get intelligent dietary advice through a chatbot

    ---

    ### 🚀 How to Use This App
    1. Go to **Nutrition Analysis** to input your meal, explore its nutrition profile and compare it with the recommended intake values.
    2. Head over to **Chatbot** to ask questions like:
    - "Is my meal good for weight loss?"
    - "What can I add to increase protein?"

    Use the **sidebar navigation** to switch between sections.

    Enjoy your nutritional journey! 💪
    """)

# --- Nutrition Analysis ---
elif menu == "🥗 Nutrition Analysis":
...
# --- Chatbot Section ---
elif menu == "🤖 Nutrition Chatbot":
    st.title("🤖 Chat with Nutrition Bot")
